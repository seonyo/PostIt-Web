...
import styles from '../../css/Search/searchDetail.module.css'
...
const SearchDetail: React.FC = () => {
    ...
    //state를 이용해서 프로젝트 팀의 정보를 가져온다.
    const handleSelectPage = (teamName: string) => {
        navigate("/search/result", { state: { teamName } });
    };
